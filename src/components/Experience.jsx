...
function Experience() {
  return (
    <section className="p-6 animate-fadeIn bg-white rounded-lg shadow-md">
      <h2 className="md:text-3xl text-2xl font-semibold text-gray-800 mb-4">Education</h2>
      <hr />
      ...
      {experience.Projects.map((item, id) => (
        <div key={id} className="mb-3 bg-gray-50 rounded-lg flex flex-col gap-1 shadow-md p-4">
